...
export class TagsController {
  ...
  create(
    ...
    return this.tagsService.create(createTagDto, spaceId);
  }
  ...
  update(
    ...
    return this.tagsService.update(id, updateTagDto, spaceId);
  }

  @Delete(':id')
  remove(@Param('id') id: string, @GetUser('spaceId') spaceId: string) {
    return this.tagsService.remove(id, spaceId);
  }
}
